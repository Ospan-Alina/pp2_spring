...
image = pygame.image.load("images/mainclock.png")
imageL = pygame.image.load("images/leftarm.png")
imageR = pygame.image.load("images/rightarm.png")
...
while not done: 
        ...
        minute_angle = (curr_min +4 / 60) * (-360)   
